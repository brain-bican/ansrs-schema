# Contributing to ansrs-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
ansrs-schema. These guidelines are not strict rules.
...
The ansrs-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the ansrs-schema technical leads
...
[issues]: https://github.com/my-org/ansrs-schema/issues/
[pulls]: https://github.com/my-org/ansrs-schema/pulls/
